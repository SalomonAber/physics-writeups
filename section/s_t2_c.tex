...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
      \begin{axis}[ylabel={voltage, v (V)},xlabel={distance, x (m)}]
        \addplot [mark = *] table [x=x,y=v]{data/t2/r_c_1.txt};
        \addlegendentry{observed}
        \addplot [thick, red] table [x=x,y=e]{data/t2/r_c_1.txt};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
      \begin{axis}[ylabel={voltage, v (V)},xlabel={angle, $\theta$ ($^{\circ}$)}]
        \addplot [mark = *] table [x=t,y=v]{data/t2/r_c_2.txt};
        \addlegendentry{observed}
        \addplot [thick, red] table [x=t,y=e]{data/t2/r_c_2.txt};
        \addlegendentry{expected}
      \end{axis}
    \end{tikzpicture}
