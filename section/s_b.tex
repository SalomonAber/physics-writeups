...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[ylabel={Pressure (Pa)},xlabel={Volume (cm$^3$)}]
      \addplot[line width=1,color=blue,smooth,each nth point=5] table [x=v,y=p]{data/r_b_1_1.txt};
      \addplot[line width=1,color=red,smooth,each nth point=5] table [x=v,y=p]{data/r_b_1_2.txt};
      \legend{p=3,p=2}
    \end{axis}
  \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[ylabel={Volume (cm$^3$)},xlabel={Temperature ($^\circ$C)}]
      \addplot [only marks, mark = *] table [x=t,y=v]{data/r_b_2.txt};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[ylabel={Pressure (Pa)},xlabel={Temperature ($^\circ$C)}]
      \addplot [only marks, mark = *] table [x=t,y=p]{data/r_b_3.txt};
      \addplot [thick, red] table [
        x=t,
